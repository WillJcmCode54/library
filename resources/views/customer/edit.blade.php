...
<div class="card">
    ...
    <form action="{{ route('customer.update',['id'=> $customer->id]) }}" method="post">
        ...
        <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="input-group mb-3">
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                               value="{{ $customer->name }}" placeholder="{{ __('Nombre') }}" required="required"autofocus>
                ...
                <div class="col-md-6">
                    <div class="input-group mb-3">
                        <input type="text" name="last_name" class="form-control @error('last_name') is-invalid @enderror"
                               value="{{ $customer->last_name }}" placeholder="{{ __('Apellido') }}" required="required"autofocus>
                ...
                <div class="col-md-4">
                    <div class="input-group mb-3">
                        <input type="text" name="number_id" class="form-control @error('number_id') is-invalid @enderror"
                               value="{{ $customer->number_id }}" placeholder="{{ __('Cédula') }} por defecto(V00000000)" required="required"autofocus>
                ...
                <div class="col-md-4">
                    <div class="input-group mb-3">
                        <input type="tel" name="phone" class="form-control @error('phone') is-invalid @enderror"
                               value="{{ $customer->phone }}" placeholder="{{ __('Teléfono') }} por defecto(+5800000000)" required="required"autofocus>
                ...
                <div class="col-md-4">
                    <div class="input-group mb-3">
                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                               value="{{ $customer->email }}" placeholder="{{ __('Correo') }}">
            ...
            <div class="row">
                <div class="col">
                    <x-adminlte-textarea name="address" label="Direccion" rows=5  igroup-size="sm" placeholder="Inserte la direccion...">{{ $customer->address }}
